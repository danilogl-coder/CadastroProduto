...
<form name="form1" action="index.php?link=4&acao=<?php if(!isset($metodo)){echo'inserir';}elseif($metodo == 'alterar'){echo 'alterar';}else{echo "excluir";}?>" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="custo" class="form-control" value="<?php if(isset($custo)){echo $custo;}else{echo "";}?>">
    </div>
    <div class="mb-3">
    ...
    <input type="submit" class="btn btn-primary" value="<?php if(!isset($metodo)){echo 'inserir';}elseif($metodo == 'alterar'){echo "alterar";}else{echo "excluir";} ?>">
</form>